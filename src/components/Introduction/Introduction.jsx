...
const Introduction = () => {
  ...
  return (
    <div className="pb-10 relative">
      <div className="stroke_text text-6xl md:text-8xl lg:text-9xl absolute bottom-0 left-0 w-full text-center z-0 font-black animate-pulse font-sans">
        WELCOME
      </div>
      ...
      <div className="mt-8 lg:mt-14 ml-6">
        ...
        <h1 className="font-bold text-4xl md:text-7xl lg:text-[80px] text-transparent bg-clip-text bg-gradient-to-r from-[#8750f7] to-[#dddddd] font-sora mt-5">
          I&apos;m Arnab Gupta
        </h1>
