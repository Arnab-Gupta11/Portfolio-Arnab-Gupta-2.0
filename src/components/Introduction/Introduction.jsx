...
const Introduction = () => {
  return (
    <Container>
      <div
        id="home"
        className="relative pb-8 xsm:pb-12 pt-5 md:pt-8"
      >
        {/* Background Image */}
        ...
        <div className="relative z-10">
          ...
          <div className="mt-8 lg:mt-12 ml-4 xs:ml-0 text-center">
            <motion.h3
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="font-bricolage text-xs xsm:text-lg sm:text-xl xl:text-2xl 2xl:text-4xl font-semibold text-primary-600 dark:text-[#f0f2f5b3]"
            >
              Hi there!👋
            </motion.h3>
            <motion.h1
            ...
            >
              ...
              >
                <Button
                  ...
                  iconPosition={"right"}
                  iconAnimation={
                    "transform transition-transform duration-500 group-hover:rotate-45 font-semibold"
                  }
                  className={"z-10"}
                >
                  My Works
