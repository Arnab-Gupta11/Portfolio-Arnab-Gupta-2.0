    ...
    <div className="p-5 ">
      <div className="flex justify-center">
        <div className="image-wrap w-[300px] h-[150px] md:w-[700px] md:h-[250px] lg:w-[1000px] lg:h-[300px] xl:w-[1000px] overflow-hidden xl:h-[400px]">
          <img src={data?.fullImage} className="rounded-md" />
        </div>
      </div>

      <div className="mt-5 mb-10">
        <h1 className="text-base sm:text-lg md:text-xl xl:text-3xl font-bold font-sora xl:h-12 text-transparent bg-clip-text bg-title-gradient-light dark:bg-title-gradient text-center">
          {data?.title}
        </h1>
        ...
        <h3 className="font-bricolage text-xs xsm:text-sm sm:text-base ">
          <span className="text-primary-500 dark:text-secondary-200 font-semibold ">Type: </span>{" "}
          <span className="text-primary-600 dark:text-secondary-100 font-normal">{data?.type}</span>{" "}
        </h3>
        <h3 className="font-bricolage">
          ...
          <span className="text-primary-600 dark:text-secondary-100 font-normal text-xs xsm:text-sm sm:text-base">{data?.technologies}</span>{" "}
        </h3>
        <div className="divider mt-3.5 md:mt-5"></div>
        <h3 className="font-bricolage mb-5">
          <span className="text-primary-500 dark:text-secondary-200 font-semibold text-xs xsm:text-sm sm:text-base">Description: </span>
          <span className="text-primary-600 dark:text-secondary-100 font-normal text-xs xsm:text-sm sm:text-base">{data?.description}</span>
        </h3>
